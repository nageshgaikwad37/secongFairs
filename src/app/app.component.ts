  ...
  FairlistArray: any[] = [
    {
        ...
        "location": "After registering, look out for an email that includes instructions for attending this event. ",
        "numberOfUsersRegistered": 0,
        "numberOfSchoolsRegistered": 43,
        "isCandidateRegistered": false,
        "bannerUrl": "https://images.unsplash.com/photo-1646071206496-0d8288613824?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1074&q=80",
    ...
    },
    {
        ...
        "location": null,
        "numberOfUsersRegistered": 0,
        "numberOfSchoolsRegistered": 38,
        "isCandidateRegistered": false,
        "bannerUrl": "https://plus.unsplash.com/premium_photo-1664285637075-7bd8abe6d26f?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1169&q=80",
        "showRegisteredUsersToCandidate": false,
        "showRegisteredUsersToSchools": false,
        "showRegisteredSchoolsToCandidate": true,
        "showRegisteredSchoolsToSchools": false,
    ...
    },
    {
        ...
        "numberOfUsersRegistered": 0,
        "numberOfSchoolsRegistered": 23,
        "isCandidateRegistered": false,
        "bannerUrl": "https://images.unsplash.com/photo-1667733807474-b53ebc043054?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1170&q=80",
        "showRegisteredUsersToCandidate": false,
        "showRegisteredUsersToSchools": false,
        "showRegisteredSchoolsToCandidate": true,
        "showRegisteredSchoolsToSchools": false,
    ...
    },
    {
        ...
        "numberOfUsersRegistered": 0,
        "numberOfSchoolsRegistered": 27,
        "isCandidateRegistered": false,
        "bannerUrl": "https://images.unsplash.com/photo-1664953524829-8bcd3f70e22c?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1332&q=80",
        "showRegisteredUsersToCandidate": false,
        "showRegisteredUsersToSchools": false,
        "showRegisteredSchoolsToCandidate": true,
        "showRegisteredSchoolsToSchools": false,
...
selectedObj:any=this.FairlistArray[0]
getemitIdto(event:any){
  console.log(event);
  this.FairlistArray.filter(ele =>{
    if(ele.fairId === event){
      this.selectedObj =ele
